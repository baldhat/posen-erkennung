...
class Fetcher(threading.Thread):
    def __init__(self, opts):
        ...
        data_paths = []
        data_paths.extend(glob.glob('D:/code/python/DualPoseNet/data/training_instance/CAMERA25_[1-2].pkl'))
        # data_paths.extend(glob.glob('D:/code/python/DualPoseNet/data/training_instance/baldhatsyn_bpycv_cl_id_*.pkl'))
        data_paths.append('D:/code/python/DualPoseNet/data/training_instance/REAL275.pkl')
        # data_paths.append('D:/code/python/DualPoseNet/data/training_instance/baldhatsyn_bpycv_cl_id_1-6_p10.pkl')
        # data_paths.append('D:/code/python/DualPoseNet/data/training_instance/baldhatsyn_bpycv_cl_id_1-6_p11.pkl')
