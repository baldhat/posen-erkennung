...
def parse(args=None):
    ...
    parser.add_argument('--model', default='REAL275', help="REAL275/CAMERA25")
    parser.add_argument('--model_name', default='model', help="The name of the model file (like 'model' oder 'my_model'")
    ...
    parser.add_argument('--old_model_name', '-omn', type=str)
    parser.add_argument('--old_model_epoch', '-omp', type=int)
    parser.add_argument('--old_model', '-om', type=str)
